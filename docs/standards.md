...
| STD-003 doc freshness | not-yet (partial pass) | The version check passes, but the known `docs/dev-process.md` prose-drift finding remains; release docs also require manual reconciliation. |
